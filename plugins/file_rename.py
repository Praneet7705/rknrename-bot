...
async def doc(bot, update):    
    ...
    ms = await update.message.edit("MOVIEPLAZA Tʀyɪɴɢ Tᴏ Dᴏᴡɴʟᴏᴀᴅɪɴɢ....")    
    try:
    ...
    await ms.edit("MOVIEPLAZA Tʀyɪɴɢ Tᴏ Uᴩʟᴏᴀᴅɪɴɢ....")
    ...
    try:
		...
		duration=duration,
	        progress=progress_for_pyrogram,
		progress_args=("MOVIEPLAZA Uᴩʟᴏᴅ Sᴛᴀʀᴛᴇᴅ....", ms, time.time()))
        elif type == "audio": 
